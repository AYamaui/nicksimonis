    ...
    <div class="swiper-container series-list">
        <div class="swiper-wrapper">
            @foreach($series as $serie)
                <div style="background: url({{$serie->original_source}}) center no-repeat; background-size: cover;"
                     class="swiper-slide">
            ...
            <div class="swiper-wrapper">
                @foreach($serie->photos as $photo)
                    <div class="swiper-slide"
                         style="background: url({{$photo->original_source}}) center no-repeat; background-size: cover;">
                        <a href="#">
