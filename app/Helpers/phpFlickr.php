...
if (!class_exists('phpFlickr')) {
    ...
    class phpFlickr
    {
        ...
        function auth_url($frob, $perms = 'read')
        {
            ...
            return sprintf('https://flickr.com/services/auth/?api_key=%s&perms=%s&frob=%s&api_sig=%s', $this->api_key,
                $perms, $frob, $sig);
        }
        ...
        function activity_userPhotos($timeframe = null, $per_page = null, $page = null)
        {
            ...
            $this->request('flickr.activity.userPhotos',
                array("timeframe" => $timeframe, "per_page" => $per_page, "page" => $page));
        ...
        function collections_getTree($collection_id = null, $user_id = null)
        {
            ...
            return $this->call('flickr.collections.getTree',
        ...
        function contacts_getList($filter = null, $page = null, $per_page = null)
        {
            ...
            $this->request('flickr.contacts.getList',
                array('filter' => $filter, 'page' => $page, 'per_page' => $per_page));
        ...
        function contacts_getPublicList($user_id, $page = null, $per_page = null)
        {
            ...
            $this->request('flickr.contacts.getPublicList',
                array('user_id' => $user_id, 'page' => $page, 'per_page' => $per_page));
        ...
        function contacts_getListRecentlyUploaded($date_lastupload = null, $filter = null)
        {
            ...
            return $this->call('flickr.contacts.getListRecentlyUploaded',
                array('date_lastupload' => $date_lastupload, 'filter' => $filter));
        }
        ...
        function favorites_getPublicList(
            $user_id,
            $jump_to = null,
            $min_fave_date = null,
            $max_fave_date = null,
        ...
        function galleries_addPhoto($gallery_id, $photo_id, $comment = null)
        {
            ...
            return $this->call('flickr.galleries.addPhoto',
                array('gallery_id' => $gallery_id, 'photo_id' => $photo_id, 'comment' => $comment));
        }
        ...
        function galleries_create($title, $description, $primary_photo_id = null)
        {
            ...
            return $this->call('flickr.galleries.create',
                array('title' => $title, 'description' => $description, 'primary_photo_id' => $primary_photo_id));
        }
        ...
        function galleries_editMeta($gallery_id, $title, $description = null)
        {
            ...
            return $this->call('flickr.galleries.editMeta',
                array('gallery_id' => $gallery_id, 'title' => $title, 'description' => $description));
        }
        ...
        function galleries_editPhoto($gallery_id, $photo_id, $comment)
        {
            ...
            return $this->call('flickr.galleries.editPhoto',
                array('gallery_id' => $gallery_id, 'photo_id' => $photo_id, 'comment' => $comment));
        }
        ...
        function galleries_editPhotos($gallery_id, $primary_photo_id, $photo_ids)
        {
            ...
            return $this->call('flickr.galleries.editPhotos',
                array('gallery_id' => $gallery_id, 'primary_photo_id' => $primary_photo_id, 'photo_ids' => $photo_ids));
        }
        ...
        function galleries_getList($user_id = null, $per_page = null, $page = null)
        {
            /* https://www.flickr.com/services/api/flickr.galleries.getList.html */
            return $this->call('flickr.galleries.getList',
                array('user_id' => $user_id, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function galleries_getListForPhoto($photo_id, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.galleries.getListForPhoto',
                array('photo_id' => $photo_id, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function galleries_getPhotos($gallery_id, $extras = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.galleries.getPhotos',
                array('gallery_id' => $gallery_id, 'extras' => $extras, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function groups_pools_getPhotos(
            $group_id,
            $tags = null,
            $user_id = null,
            $jump_to = null,
        ...
        function interestingness_getList(
            $date = null,
            $use_panda = null,
            $extras = null,
            $per_page = null,
        ...
        function machinetags_getNamespaces($predicate = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.machinetags.getNamespaces',
                array('predicate' => $predicate, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function machinetags_getPairs($namespace = null, $predicate = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.machinetags.getPairs',
                array('namespace' => $namespace, 'predicate' => $predicate, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function machinetags_getPredicates($namespace = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.machinetags.getPredicates',
                array('namespace' => $namespace, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function machinetags_getRecentValues($namespace = null, $predicate = null, $added_since = null)
        {
            ...
            return $this->call('flickr.machinetags.getRecentValues',
                array('namespace' => $namespace, 'predicate' => $predicate, 'added_since' => $added_since));
        }
        ...
        function panda_getPhotos($panda_name, $extras = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.panda.getPhotos',
                array('panda_name' => $panda_name, 'extras' => $extras, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function people_getPhotosOf($user_id, $extras = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.people.getPhotosOf',
        ...
        function photos_getContactsPhotos(
            $count = null,
            $just_friends = null,
            $single_photo = null,
            $include_self = null,
        ...
        function photos_getContactsPublicPhotos(
            $user_id,
            $count = null,
            $just_friends = null,
            $single_photo = null,
        ...
        function photos_getFavorites($photo_id, $page = null, $per_page = null)
        {
            ...
            $this->request("flickr.photos.getFavorites",
                array("photo_id" => $photo_id, "page" => $page, "per_page" => $per_page));

            return $this->parsed_response ? $this->parsed_response['photo'] : false;
        }

        function photos_getInfo(
            $photo_id,
            $secret = null,
            $humandates = null,
            $privacy_filter = null,
        ...
        function photos_getRecent($jump_to = null, $extras = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.photos.getRecent',
                array('jump_to' => $jump_to, 'extras' => $extras, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function photos_recentlyUpdated($min_date, $extras = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.photos.recentlyUpdated',
                array('min_date' => $min_date, 'extras' => $extras, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function photos_setContentType($photo_id, $content_type)
        {
            ...
            return $this->call('flickr.photos.setContentType',
        ...
        function photos_setMeta($photo_id, $title, $description)
        {
            ...
            $this->request("flickr.photos.setMeta",
                array("photo_id" => $photo_id, "title" => $title, "description" => $description), true);
        ...
        function photos_setSafetyLevel($photo_id, $safety_level = null, $hidden = null)
        {
            ...
            return $this->call('flickr.photos.setSafetyLevel',
                array('photo_id' => $photo_id, 'safety_level' => $safety_level, 'hidden' => $hidden));
        }
        ...
        function photos_comments_addComment($photo_id, $comment_text)
        {
            ...
            $this->request("flickr.photos.comments.addComment",
                array("photo_id" => $photo_id, "comment_text" => $comment_text), true);
        ...
        function photos_comments_editComment($comment_id, $comment_text)
        {
            ...
            $this->request("flickr.photos.comments.editComment",
                array("comment_id" => $comment_id, "comment_text" => $comment_text), true);

            return $this->parsed_response ? true : false;
        }

        function photos_comments_getList(
            $photo_id,
            $min_comment_date = null,
            $max_comment_date = null,
            $page = null,
            $per_page = null,
            $include_faves = null
        ) {
        ...
        function photos_geo_correctLocation($photo_id, $place_id = null, $woe_id = null)
        {
            ...
            return $this->call('flickr.photos.geo.correctLocation',
                array('photo_id' => $photo_id, 'place_id' => $place_id, 'woe_id' => $woe_id));
        }
        ...
        function photos_geo_photosForLocation(
            $lat,
            $lon,
            $accuracy = null,
            $extras = null,
        ...
        function photos_licenses_setLicense($photo_id, $license_id)
        {
            ...
            /* Requires Authentication */
            $this->request("flickr.photos.licenses.setLicense",
                array("photo_id" => $photo_id, "license_id" => $license_id), true);
        ...
        function photos_people_delete($photo_id, $user_id, $email = null)
        {
            ...
            return $this->call('flickr.photos.people.delete',
                array('photo_id' => $photo_id, 'user_id' => $user_id, 'email' => $email));
        }
        ...
        function photos_people_deleteCoords($photo_id, $user_id)
        {
            ...
            return $this->call('flickr.photos.people.deleteCoords',
                array('photo_id' => $photo_id, 'user_id' => $user_id));
        }

        function photos_people_editCoords(
            $photo_id,
            $user_id,
            $person_x,
            $person_y,
        ...
        function photosets_create($title, $description, $primary_photo_id)
        {
            ...
            $this->request("flickr.photosets.create",
                array("title" => $title, "primary_photo_id" => $primary_photo_id, "description" => $description), true);
        ...
        function photosets_editMeta($photoset_id, $title, $description = null)
        {
            ...
            $this->request("flickr.photosets.editMeta",
                array("photoset_id" => $photoset_id, "title" => $title, "description" => $description), true);
        ...
        function photosets_removePhoto($photoset_id, $photo_id)
        {
            ...
            $this->request("flickr.photosets.removePhoto",
                array("photoset_id" => $photoset_id, "photo_id" => $photo_id), true);
        ...
        function photosets_removePhotos($photoset_id, $photo_ids)
        {
            ...
            return $this->call('flickr.photosets.removePhotos',
                array('photoset_id' => $photoset_id, 'photo_ids' => $photo_ids));
        }
        ...
        function photosets_reorderPhotos($photoset_id, $photo_ids)
        {
            ...
            return $this->call('flickr.photosets.reorderPhotos',
                array('photoset_id' => $photoset_id, 'photo_ids' => $photo_ids));
        }
        ...
        function photosets_setPrimaryPhoto($photoset_id, $photo_id)
        {
            ...
            return $this->call('flickr.photosets.setPrimaryPhoto',
                array('photoset_id' => $photoset_id, 'photo_id' => $photo_id));
        }
        ...
        function photosets_comments_addComment($photoset_id, $comment_text)
        {
            ...
            $this->request("flickr.photosets.comments.addComment",
                array("photoset_id" => $photoset_id, "comment_text" => $comment_text), true);
        ...
        function photosets_comments_editComment($comment_id, $comment_text)
        {
            ...
            $this->request("flickr.photosets.comments.editComment",
                array("comment_id" => $comment_id, "comment_text" => $comment_text), true);
        ...
        function places_findByLatLon($lat, $lon, $accuracy = null)
        {
            ...
            return $this->call('flickr.places.findByLatLon',
                array('lat' => $lat, 'lon' => $lon, 'accuracy' => $accuracy));
        }
        ...
        function places_getChildrenWithPhotosPublic($place_id = null, $woe_id = null)
        {
            ...
            return $this->call('flickr.places.getChildrenWithPhotosPublic',
                array('place_id' => $place_id, 'woe_id' => $woe_id));
        }
        ...
        function places_placesForContacts(
            $place_type = null,
            $place_type_id = null,
            $woe_id = null,
            $place_id = null,
        ...
        function stats_getCollectionDomains($date, $collection_id = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getCollectionDomains',
                array('date' => $date, 'collection_id' => $collection_id, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function stats_getCollectionStats($date, $collection_id)
        {
            ...
            return $this->call('flickr.stats.getCollectionStats',
                array('date' => $date, 'collection_id' => $collection_id));
        }
        ...
        function stats_getPhotoDomains($date, $photo_id = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getPhotoDomains',
                array('date' => $date, 'photo_id' => $photo_id, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function stats_getPhotosetDomains($date, $photoset_id = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getPhotosetDomains',
                array('date' => $date, 'photoset_id' => $photoset_id, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function stats_getPhotostreamDomains($date, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getPhotostreamDomains',
                array('date' => $date, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function stats_getPhotostreamReferrers($date, $domain, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getPhotostreamReferrers',
                array('date' => $date, 'domain' => $domain, 'per_page' => $per_page, 'page' => $page));
        }
        ...
        function stats_getPopularPhotos($date = null, $sort = null, $per_page = null, $page = null)
        {
            ...
            return $this->call('flickr.stats.getPopularPhotos',
                array('date' => $date, 'sort' => $sort, 'per_page' => $per_page, 'page' => $page));
        }
